...
export const careerDepartments = [
  ...
  },
  {
    ...
    roles: [
      'مدير إدارة المحتوى الإبداعي',
      'مشرف قسم',
      'كاتب محتوى إبداعي أول',
      'كاتب محتوى إبداعي',
    ],
  },
  {
  ...
  },
  {
    ...
    roles: [
      'مدير إدارة المالية والشؤون الإدارية',
      'مشرف قسم',
      'محاسب عام',
      'محاسب',
  ...
  },
  {
    ...
    roles: [
      ...
      'محرر فيديو أول',
      'محرر فيديو',
      'مصمم رسوم متحركة أول',
      'مصمم رسوم متحركة',
      'رسام أول',
      'رسام',
      'أخصائي أول إبداعي بالذكاء الاصطناعي',
      'أخصائي إبداعي بالذكاء الاصطناعي',
    ],
  },
] as const

export const careerSpecialties = careerDepartments.flatMap((department) =>
...
export const contactPaths = {
  ...
  career: {
    label: 'انضم كموظف',
    eyebrow: '05.2 — انضم كموظف',
    title: 'لديك شغف؟\nاصنع أثره معنا.',
    description:
      'نبحث دائمًا عن المواهب التي ترى التفاصيل بطريقة مختلفة. عرّفنا بخبرتك وشاركنا أفضل أعمالك.',
  },
}
